/*
This is the example code off https://stasis.hackclub.com/starter-projects/spotify-display, 
will be edited later for extra features once barebones functionality is confirmed. 
*/
